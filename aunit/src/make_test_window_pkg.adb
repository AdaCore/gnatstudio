...
package body Make_Test_Window_Pkg is
   ...
   procedure Initialize
     (Make_Test_Window : access Make_Test_Window_Record'Class) is
   ...
   begin
      ...
      Pack_Start
        (Make_Test_Window.Vbox0, Make_Test_Window.Hbox1, True, True, 0);

      Gtk_New_Vbox (Make_Test_Window.Vbox1, True, 0);
      Pack_Start
        (Make_Test_Window.Hbox1, Make_Test_Window.Vbox1, False, False, 5);

      Gtk_New (Make_Test_Window.Label1, -("Unit name : "));
      Pack_Start
        (Make_Test_Window.Vbox1, Make_Test_Window.Label1, False, False, 0);
      ...
      Pack_Start
        (Make_Test_Window.Vbox1, Make_Test_Window.Label2, False, False, 0);
      ...
      Pack_Start
        (Make_Test_Window.Vbox1, Make_Test_Window.Label3, False, False, 0);
      ...
      Pack_Start
        (Make_Test_Window.Vbox1, Make_Test_Window.Label4, False, False, 0);
      ...
      Pack_Start
        (Make_Test_Window.Hbox1, Make_Test_Window.Vbox2, True, True, 3);

      Gtk_New (Make_Test_Window.Name_Entry);
      Pack_Start
        (Make_Test_Window.Vbox2, Make_Test_Window.Name_Entry, False, False, 0);
      ...
      Pack_Start
        (Make_Test_Window.Vbox2,
         Make_Test_Window.Description_Entry, False, False, 0);
      Entry_Callback.Connect
