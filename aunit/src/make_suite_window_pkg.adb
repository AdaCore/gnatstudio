...
package body Make_Suite_Window_Pkg is
   ...
   procedure Initialize
     (Make_Suite_Window : access Make_Suite_Window_Record'Class) is
      pragma Suppress (All_Checks);
   begin
      Gtk.Window.Initialize (Make_Suite_Window, Window_Toplevel);
      Return_Callback.Connect
        (Make_Suite_Window,
         "delete_event", On_Make_Suite_Window_Delete_Event'Access);
      ...
      Pack_Start
        (Make_Suite_Window.Vbox1, Make_Suite_Window.Hbox1, False, True, 3);

      Gtk_New_Vbox (Make_Suite_Window.Vbox2, True, 0);
      Pack_Start
        (Make_Suite_Window.Hbox1, Make_Suite_Window.Vbox2, False, False, 5);

      Gtk_New (Make_Suite_Window.Label1, -("Suite name :"));
      Pack_Start
        (Make_Suite_Window.Vbox2, Make_Suite_Window.Label1, False, False, 0);
      ...
      Pack_Start
        (Make_Suite_Window.Hbox1, Make_Suite_Window.Vbox3, True, True, 3);

      Gtk_New (Make_Suite_Window.Name_Entry);
      Pack_Start
        (Make_Suite_Window.Vbox3,
         Make_Suite_Window.Name_Entry, False, False, 1);
      ...
      Pack_Start
        (Make_Suite_Window.Vbox1, Make_Suite_Window.Vbox4, True, True, 0);

      Gtk_New
        (Make_Suite_Window.Label2,
         -("The following tests will be added to the new suite :"));
      Pack_Start
        (Make_Suite_Window.Vbox4, Make_Suite_Window.Label2, False, False, 0);
      ...
      Pack_Start
        (Make_Suite_Window.Vbox4, Make_Suite_Window.Hbox2, True, True, 0);

      Gtk_New (Make_Suite_Window.Scrolledwindow2);
      Pack_Start
        (Make_Suite_Window.Hbox2,
         Make_Suite_Window.Scrolledwindow2, True, True, 0);
      Set_Policy
        (Make_Suite_Window.Scrolledwindow2,
      ...
      Set_Reorderable (Make_Suite_Window.Test_List, True);
      ...
      Set_Column_Widget
        (Make_Suite_Window.Test_List, 0, Make_Suite_Window.Label5);
      ...
      Set_Column_Widget
        (Make_Suite_Window.Test_List, 1, Make_Suite_Window.Label6);
      ...
      Set_Column_Widget
        (Make_Suite_Window.Test_List, 2, Make_Suite_Window.Label7);

      Gtk_New (Make_Suite_Window.Vbuttonbox1);
      Pack_Start
        (Make_Suite_Window.Hbox2,
         Make_Suite_Window.Vbuttonbox1, False, True, 0);
      ...
      Pack_Start
        (Make_Suite_Window.Vbox1,
         Make_Suite_Window.Hbuttonbox1, False, False, 0);
