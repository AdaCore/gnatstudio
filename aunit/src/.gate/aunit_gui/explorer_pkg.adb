...
begin
   ...
   Gtk_New_Vbox (Explorer.Vbox15, False, 0);
   Add (Explorer, Explorer.Vbox15);

   Gtk_New (Explorer.Scrolledwindow3);
   Set_Policy (Explorer.Scrolledwindow3, Policy_Automatic, Policy_Automatic);
   Pack_Start (Explorer.Vbox15, Explorer.Scrolledwindow3, True, True, 0);
   ...
   Gtk_New (Explorer.Label12, -("label3"));
   Set_Alignment (Explorer.Label12, 0.5, 0.5);
   Set_Padding (Explorer.Label12, 0, 0);
   Set_Justify (Explorer.Label12, Justify_Center);
   Set_Line_Wrap (Explorer.Label12, False);
   Set_Column_Widget (Explorer.Clist, 0, Explorer.Label12);

   Gtk_New (Explorer.Label13, -("label4"));
   Set_Alignment (Explorer.Label13, 0.5, 0.5);
   Set_Padding (Explorer.Label13, 0, 0);
   Set_Justify (Explorer.Label13, Justify_Center);
   Set_Line_Wrap (Explorer.Label13, False);
   Set_Column_Widget (Explorer.Clist, 1, Explorer.Label13);

   Gtk_New (Explorer.Hbuttonbox4);
   Set_Spacing (Explorer.Hbuttonbox4, 30);
   Set_Layout (Explorer.Hbuttonbox4, Buttonbox_Spread);
   Set_Child_Size (Explorer.Hbuttonbox4, 85, 27);
   Set_Child_Ipadding (Explorer.Hbuttonbox4, 7, 0);
   Pack_Start (Explorer.Vbox15, Explorer.Hbuttonbox4, False, True, 0);
   ...
   Add (Explorer.Hbuttonbox4, Explorer.Ok);
   ...
   Add (Explorer.Hbuttonbox4, Explorer.Close);
