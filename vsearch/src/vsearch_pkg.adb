...
package body Vsearch_Pkg is
   ...
   begin
      ...
      --    (Vsearch.Replace_Combo, Replace_Combo_Items);
      ...
      --  Combo.Set_Popdown_Strings
      --    (Vsearch.Context_Combo, Context_Combo_Items);
      ...
      --  Combo.Set_Popdown_Strings
      --    (Vsearch.Pattern_Combo, Pattern_Combo_Items);
      ...
      Set_Tip (Tooltips,
               Vsearch.Pattern_Entry, -"The searched word or pattern");

      Gtk_New_Hbox (Vsearch.Buttons_Hbox, False, 0);
      --  Pack_Start
      --    (Vsearch.Vbox_Search, Vsearch.Buttons_Hbox, False, False, 0);
      ...
      --  Pack_Start
      --    (Vsearch.Vbox_Search, Vsearch.Options_Frame, False, False, 0);
