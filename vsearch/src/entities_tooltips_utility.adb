...
package body Entities_Tooltips_Utility is
   ...
   function Get_Tooltip_Header (Entity : Entity_Access) return String is
   begin
   ...
   function Get_Tooltip_Documentation
     (Kernel : access Kernel_Handle_Record'Class;
      ...
      Ref    : Root_Entity_Reference'Class) return String is
   begin
      return
        Get_Instance (Ref)
        & Documentation
        ...
        Documentation
          (Self                     => Kernel.Databases,
           ...
           Color_For_Optional_Param =>
             To_Hex (Shade_Or_Lighten (Tooltips.Tooltips_Foreground_Color)),
           Entity                   =>
             From_Constructs (Kernel.Databases, Entity));
   end Get_Tooltip_Documentation;
   ...
   function Is_Guess (Entity : Root_Entity'Class) return Boolean is
   begin
   ...
   function Tooltip_Guess_Message return String is
   begin
