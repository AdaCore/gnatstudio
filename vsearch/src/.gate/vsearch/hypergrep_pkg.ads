...
package Hypergrep_Pkg is

   type Hypergrep_Record is new Gtk_Window_Record with record
      Main_Box : Gtk_Vbox;
   ...
   type Hypergrep_Access is access all Hypergrep_Record'Class;

   procedure Gtk_New (Hypergrep : out Hypergrep_Access);
   procedure Initialize (Hypergrep : access Hypergrep_Record'Class);

   Hypergrep : Hypergrep_Access;
