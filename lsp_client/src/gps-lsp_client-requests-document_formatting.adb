...
package body GPS.LSP_Client.Requests.Document_Formatting is
   ...
   begin
      ...
      Abstract_Document_Formatting_Request'Class (Self).On_Result_Message
        (Response);
   ...
   function Params
     (Self : Abstract_Document_Formatting_Request)
      return LSP.Structures.DocumentFormattingParams is
   begin
      return
        (workDoneToken => <>,
         textDocument  =>
   ...
   begin
      LSP.Outputs.Write_DocumentFormattingParams (Handler, Self.Params);
   end Params;
