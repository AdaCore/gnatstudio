...
package GPS.LSP_Client.Requests.Execute_Command.Reload_Project is
   ...
   overriding
   procedure On_Result_Message (Self : in out Reload_Project_Command_Request)
   is null;
   ...
   function Command_Name
     (Self : Reload_Project_Command_Request) return VSS.Strings.Virtual_String
   is ("als-reload-project");
