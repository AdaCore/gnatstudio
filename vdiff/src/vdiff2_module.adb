...
package body Vdiff2_Module is
   ...
   function Filter_Matches_Primitive
     (Filter : access In_Diff_List_Filter; Context : Selection_Context)
      return Boolean;
   ...
   overriding
   function Filter_Matches_Primitive
     (Filter : access In_3Diff_List_Filter; Context : Selection_Context)
      return Boolean;
   ...
   overriding
   function Filter_Matches_Primitive
     (Filter : access Has_File_And_Dir_Filter; Context : Selection_Context)
      return Boolean;
   ...
   Vdiff_Create_Parameters : constant Cst_Argument_List :=
     (1 => File1_Cst'Access, 2 => File2_Cst'Access, 3 => File3_Cst'Access);

   procedure Register_Commands (Kernel : access Kernel_Handle_Record'Class);
   --  Register commands specific to the Vdiff2 module

   procedure Vdiff_Cmds (Data : in out Callback_Data'Class; Command : String);
   ...
   begin
      ...
      Register_Command
        (Kernel,
         ...
         Vdiff_Class,
         Static_Method => True);
      Register_Command (Kernel, "files", 0, 0, Vdiff_Cmds'Access, Vdiff_Class);
      Register_Command
        (Kernel,
         "get",
         1,
   ...
   begin
      if Command = Constructor_Method then
         Set_Error_Msg
           (Data,
            -("Cannot build instances of Vdiff."
         ...
         begin
            ...
            if Vdiff_List = null or else Vdiff_List.Is_Empty then
               return;
            end if;
