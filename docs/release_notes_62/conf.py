...
html_style = 'adacore.css'     # also change this to change the theme
...
latex_documents = [
  ('index', 'ReleaseNotes.tex', u'Release Notes Documentation',
   u'AdaCore', 'manual'),
]
...
man_pages = [
    ('index', 'releasenotes', u'Release Notes Documentation',
     [u'AdaCore'], 1)
]
...
texinfo_documents = [
  ('index', 'ReleaseNotes', u'Release Notes Documentation',
   u'AdaCore', 'ReleaseNotes', 'One line description of project.',
   'Miscellaneous'),
]
