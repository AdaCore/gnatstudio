...
package body Codefix_Window_Pkg is
   ...
   procedure Initialize
     (Codefix_Window : access Codefix_Window_Record'Class)
   is
   ...
   begin
      ...
      Pack_Start
        (Codefix_Window.Vbox6, Codefix_Window.Error_Caption, False, False, 0);
      ...
      Pack_Start
        (Codefix_Window.Vbox6, Codefix_Window.Choices_Proposed, True, True, 0);
      ...
      Combo.Set_Popdown_Strings
        (Codefix_Window.Fix_Caption_List, Fix_Caption_List_Items);
      Free_String_List (Fix_Caption_List_Items);
      Pack_Start (Codefix_Window.Vbox6,
                  Codefix_Window.Fix_Caption_List, False, False, 0);
      ...
      Widget_Callback.Object_Connect
        (Codefix_Window.Fix_Entry, Signal_Changed,
      ...
      Widget_Callback.Object_Connect
        (Codefix_Window.Prev, Signal_Clicked,
      ...
      Set_Tip (Tooltips, Codefix_Window.Next,
               -"Go to next error without fixing the current one");
      Widget_Callback.Object_Connect
        (Codefix_Window.Next, Signal_Clicked,
      ...
      Set_Tip (Tooltips, Codefix_Window.Accept_Correction,
               -"Fix this error and go to next one");
      Widget_Callback.Object_Connect
        (Codefix_Window.Accept_Correction, Signal_Clicked,
      ...
      Widget_Callback.Object_Connect
        (Codefix_Window.Undo, Signal_Clicked,
      ...
      Set_Tip (Tooltips, Codefix_Window.Refresh,
               -"Recompute fix with last user's changes");
      Widget_Callback.Object_Connect
        (Codefix_Window.Refresh, Signal_Clicked,
