...
package body Final_Window_Pkg is
   ...
   begin
      ...
      Pack_Start (Final_Window.Dialog_Action_Area1,
               Final_Window.Hbuttonbox1, True, True, 0);
      ...
      Widget_Callback.Object_Connect
        (Final_Window.Final_Validation, "clicked",
         Widget_Callback.To_Marshaller (On_Final_Validation_Clicked'Access),
         Final_Window);
      ...
      Widget_Callback.Object_Connect
        (Final_Window.Final_Cancel, "clicked",
         Widget_Callback.To_Marshaller (On_Final_Cancel_Clicked'Access),
         Final_Window);
      Add (Final_Window.Hbuttonbox1, Final_Window.Final_Cancel);

      Gtk_New (Final_Window.Label4,
         -("All fixable errors scaned. Are you sure to update changes ?"));
      ...
      Pack_Start
        (Final_Window.Dialog_Vbox1, Final_Window.Label4, True, False, 0);
