...
def test_driver():
    ...
    yield check_variable(
        children.data[2], "V.field2", "char *", r'^0x[0-9a-f]+ "ab"', True
    )
    ...
    yield check_variable(
        children.data[2], "V2.field2", "char *", r'^0x[0-9a-f]+ "ab"', True
    )
    ...
    yield check_variable(
        children.data[0], "cl2.<CL2>", "int (**)(void)", r"^0x[0-9a-f]+", True
    )
    ...
    yield check_variable(
        children.data[0], "Mror.c", "My_Record_Of_Record::Field1_Record", ""
    )
    ...
    yield check_variable(
        children1.data[0], "Mrora[0].c", "My_Record_Of_Record::Field1_Record", ""
    )
    ...
    yield check_variable(
        children1.data[0], "Mrora[1].c", "My_Record_Of_Record::Field1_Record", ""
    )
    ...
    yield check_variable(
        children.data[0], "Mrorpa[0]", "My_Record_Of_Record *", r"^0x[0-9a-f]+", True
    )
    yield check_variable(
        children.data[1], "Mrorpa[1]", "My_Record_Of_Record *", r"^0x[0-9a-f]+", True
    )
    ...
    yield check_variable(
        children1.data[2], "Uni2.a.field2", "char *", r"^0x[0-9a-f]+", True
    )
    ...
    yield check_variable(
        children.data[1], "Uni3.field1", "float", r"^3.4[0-9,-]+", True
    )
    children1 = yield get_children(children.data[0])
    ...
    yield check_variable(
        children.data[0], "asa[0]", "void (*)(void)", r"^0x[0-9a-f]+ \<foo\(\)\>", True
    )
    yield check_variable(
        children.data[1], "asa[1]", "void (*)(void)", r"^0x[0-9a-f]+ \<foo\(\)\>", True
    )
    ...
    yield check_variable(
        children.data[0], "list.chain", "tree_node *", r"^0x[0-9a-f]+", True
    )
    ...
    children2 = yield get_children(children1.data[0])
    gps_assert(
        len(children2.data), 3, "Invalid count of MI.Second_Class.First_Class children"
    )
    yield check_variable(
        children2.data[0], "MI.Second_Class.First_Class.public_var", "int", "1"
    )
    yield check_variable(
        children2.data[1], "MI.Second_Class.First_Class.protected_var", "int", "2"
    )
    yield check_variable(
        children2.data[2], "MI.Second_Class.First_Class.private_var", "int", "3"
    )
    yield check_variable(
        children1.data[1], "MI.Second_Class.second_public_var", "int", "4"
    )
    yield check_variable(
        children1.data[2], "MI.Second_Class.second_protected_var", "int", "5"
    )
    yield check_variable(
        children1.data[3], "MI.Second_Class.second_private_var", "int", "6"
    )
    yield check_variable(
        children.data[1], "MI.<Struct_As_Class>", "Struct_As_Class", ""
    )
