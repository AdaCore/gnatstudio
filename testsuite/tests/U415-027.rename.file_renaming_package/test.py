...
EXPECTED_AFTER_RENAME = ["Test", [".", ["barz.ads", "barz.adb"], "."]]

EXPECTED_AFTER_UNDO = ["Test", [".", ["bar.ads", "bar.adb"], "."]]
...
def run_test():
    ...
    prj_view.compare_contents(
        EXPECTED_AFTER_RENAME, msg="The files should have been renamed too"
    )
    ...
    gps_assert(current_loc.column(), 19, "Wrong column after Go To Declaration")
