...
package Language.C is
   ...
   overriding
   function Keywords (Lang : access C_Language) return Strings.String_Access;
   ...
   overriding
   function Scope_Separator (Lang : access C_Language) return String;
   ...
   procedure Parse_Entities
     (Lang : access C_Language; Buffer : String; Callback : Entity_Callback);
...
private
   ...
   overriding
   function Entities_Indexed (Self : C_Language) return Boolean;
