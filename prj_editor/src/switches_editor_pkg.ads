...
package Switches_Editor_Pkg is
   ...
   type Switches_Editor_Record is new Gtk_Window_Record with record
      ...
      Vbox55 : Gtk_Vbox;
      Align_Colons : Gtk_Check_Button;
      Align_Assign_Decl : Gtk_Check_Button;
      Align_Assign_Stmt : Gtk_Check_Button;
      Align_Arrow : Gtk_Check_Button;
      Set_Labels : Gtk_Check_Button;
      Pp_Casing_Frame : Gtk_Frame;
      Pp_Casing_Table : Gtk_Table;
      Keyword_Casing : Gtk_Combo;
      Keyword_Casing_Entry : Gtk_Entry;
      Label67 : Gtk_Label;
      Label68 : Gtk_Label;
      Attribute_Casing : Gtk_Combo;
      Attribute_Casing_Entry : Gtk_Entry;
      Label69 : Gtk_Label;
      References_Casing : Gtk_Combo;
      References_Casing_Entry : Gtk_Entry;
      Label70 : Gtk_Label;
      Pragma_Casing : Gtk_Combo;
      Pragma_Casing_Entry : Gtk_Entry;
      Pp_Layout_Frame : Gtk_Frame;
      Pp_Layout_Table : Gtk_Table;
      Label65 : Gtk_Label;
      Label66 : Gtk_Label;
      Construct_Layout : Gtk_Combo;
      Construct_Layout_Entry : Gtk_Entry;
      Comments_Layout : Gtk_Combo;
      Comments_Layout_Entry : Gtk_Entry;
      Gnat_Comment_Begin : Gtk_Check_Button;
      Reformat_Comment : Gtk_Check_Button;
      Pp_Spacing_Frame : Gtk_Frame;
      Table5 : Gtk_Table;
      Label63 : Gtk_Label;
