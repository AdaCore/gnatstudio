...
begin
   ...
   Id := Widget_Callback.Object_Connect
     (Switches_Editor.Notebook1, "switch_page", Refresh_All_Switches'Access,
      Switches_Editor);
   Handler_Block (Switches_Editor.Notebook1, Id);
   ...
   Handler_Unblock (Switches_Editor.Notebook1, Id);
