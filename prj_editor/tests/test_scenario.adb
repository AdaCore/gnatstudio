...
procedure Test_Scenario is
   ...
   Output_Project                     : Project_Node_Id;
...
begin
   ...
   Set_Value_As_External (Var1, "EXT_1");
   ...
   Set_Value_As_External (Var2, "EXT_2");
   ...
   Set_Value_As_External (Var3, "EXT_3");
...
--   Set_Scenario_Name (Mgr, (Val4, Val2, Val6), "SCENAR_4_2_6");
   ...
   Output_Project := Create_Project ("Foo.Internal", "");
   Append_Declaration (Mgr, Output_Project);
   Pretty_Print (Output_Project);
end Test_Scenario;
