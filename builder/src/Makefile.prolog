...
# function to change all upper case letters to lower case.
# used for LANGUAGES.
...
# to_absolute (names, dir)
# names is a space separated list of path names.
# each path name that is not already an absolute
# path name is relative to dir; it is changed
...
# extend (names, dir)
# first to_absolute (names, dir) is called.
# then each path name that ends with "/**" is
# processed to replace it with the list of all
# directories below the directory whose path name
# precedes the "/**".
