...
package body Browsers.Elaborations.Cycle_Parser_20 is
   ...
   Info_Pattern : constant Pattern_Matcher := Compile ("^" & Info & "$");
         ...
         case Self.State is
            ...
            when Cycle         =>
               ...
               begin
                  ...
                  elsif Rest_Of_Item = "is in the closure of pragma Elaborate"
                  then
                     Dep :=
                       Create_Dependency
                         (To_String (Before),
                  ...
                  elsif Rest_Of_Item = "is subject to pragma Elaborate_Body"
                  then
                     Dep :=
                       Create_Dependency
                         (To_String (Before),
                  ...
                  then
                     ...
                     Dep :=
                       Create_Dependency
                         (To_String (Before), To_String (After), Withed);
                     Append (Self.Last_Error, Dep);
                  ...
                  if Matched (0) /= No_Match then
                     ...
                     if Matched (0) /= No_Match then
                        ...
                        GPS.Kernel.Messages.Simple.Create_Simple_Message
                          (Container  =>
                             GPS.Kernel.Get_Messages_Container (Self.Kernel),
