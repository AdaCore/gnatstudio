package body Database is
   ...
   function FK
     (Self : T_Entities'Class; Foreign : T_Resources'Class) return SQL_Criteria
   is
   begin
   ...
   function FK
     (Self : T_Messages'Class; Foreign : T_Rules'Class) return SQL_Criteria is
   begin
   ...
   function FK
     (Self : T_Rules'Class; Foreign : T_Tools'Class) return SQL_Criteria is
   begin
