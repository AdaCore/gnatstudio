...
package Database.Orm is
   ...
   type Detached_Entity_Message is  --  Get() returns a Entity_Message_DDR
     new Sessions.Detached_Element with private;
   type Detached_Entity_Message_Access is
     access all Detached_Entity_Message'Class;
   ...
   type Detached_Message_Property is  --  Get() returns a Message_Property_DDR
     new Sessions.Detached_Element with private;
   type Detached_Message_Property_Access is
     access all Detached_Message_Property'Class;
   ...
   type Detached_Resource_Tree is  --  Get() returns a Resource_Tree_DDR
     new Sessions.Detached_Element with private;
   type Detached_Resource_Tree_Access is
     access all Detached_Resource_Tree'Class;
   ...
   type Detached_Resource_Message is  --  Get() returns a Resource_Message_DDR
     new Sessions.Detached_Element with private;
   type Detached_Resource_Message_Access is
     access all Detached_Resource_Message'Class;
   ...
   function From_Cache
     (Session : Session_Type; Id : Integer) return Detached_Rule'Class;
   --  Check whether there is already an element with this primary key. If
   --  not, the returned value will be a null element (test with Is_Null)
   ...
   function "="
     (Op1 : Resource_Message; Op2 : Resource_Message) return Boolean;
   function "="
   ...
   function "="
     (Op1 : Detached_Message; Op2 : Detached_Message) return Boolean;
   --  Compares two elements using only the primary keys. All other fields are
   --  ignored
   ...
   procedure Set_Rule_Id
     (Self : Detached_Message; Value : Detached_Rule'Class);
   ...
   function From_Cache
     (Session : Session_Type; Id : Integer) return Detached_Message'Class;
   --  Check whether there is already an element with this primary key. If
   --  not, the returned value will be a null element (test with Is_Null)
   ...
   function Resource_Id
     (Self : Detached_Entity) return Detached_Resource'Class;
   procedure Set_Resource_Id
   ...
   function From_Cache
     (Session : Session_Type; Id : Integer) return Detached_Entity'Class;
   --  Check whether there is already an element with this primary key. If
   --  not, the returned value will be a null element (test with Is_Null)
   ...
   function "="
     (Op1 : Message_Property; Op2 : Message_Property) return Boolean;
   function "="
   ...
   function From_Cache
     (Session : Session_Type; Id : Integer) return Detached_Tool'Class;
   --  Check whether there is already an element with this primary key. If
   --  not, the returned value will be a null element (test with Is_Null)
   ...
   function "="
     (Op1 : Detached_Property; Op2 : Detached_Property) return Boolean;
   --  Compares two elements using only the primary keys. All other fields are
   --  ignored
   ...
   function From_Cache
     (Session : Session_Type; Id : Integer) return Detached_Property'Class;
   --  Check whether there is already an element with this primary key. If
   --  not, the returned value will be a null element (test with Is_Null)
   ...
   function "="
     (Op1 : Detached_Resource; Op2 : Detached_Resource) return Boolean;
   --  Compares two elements using only the primary keys. All other fields are
   --  ignored
   ...
   function From_Cache
     (Session : Session_Type; Id : Integer) return Detached_Resource'Class;
   --  Check whether there is already an element with this primary key. If
   --  not, the returned value will be a null element (test with Is_Null)
   ...
   package I_Entities_Messages is new
     Generic_Managers
       (I_Entities_Messages_Managers,
        Entity_Message,
        Related_Depth,
        DBA.Entities_Messages,
        Internal_Query_Entities_Messages);
   type Entities_Messages_Managers is new I_Entities_Messages.Manager
   with null record;
   subtype Entities_Messages_Stmt is
     I_Entities_Messages.ORM_Prepared_Statement;
   ...
   Empty_Entity_Message_List        : constant Entity_Message_List :=
     I_Entities_Messages.Empty_List;
   ...
   type I_Messages_Properties_Managers is abstract new Manager
   with null record;
   package I_Messages_Properties is new
     Generic_Managers
       (I_Messages_Properties_Managers,
        Message_Property,
        Related_Depth,
        DBA.Messages_Properties,
        Internal_Query_Messages_Properties);
   type Messages_Properties_Managers is new I_Messages_Properties.Manager
   with null record;
   subtype Messages_Properties_Stmt is
     I_Messages_Properties.ORM_Prepared_Statement;
   ...
   Empty_Message_Property_List        : constant Message_Property_List :=
     I_Messages_Properties.Empty_List;
   Empty_Direct_Message_Property_List :
     constant Direct_Message_Property_List :=
       I_Messages_Properties.Empty_Direct_List;

   type I_Properties_Managers is abstract new Manager with null record;
   package I_Properties is new
     Generic_Managers
       (I_Properties_Managers,
        Property,
        Related_Depth,
        DBA.Properties,
   ...
   Empty_Property_List        : constant Property_List :=
     I_Properties.Empty_List;
   ...
   package I_Resource_Trees is new
     Generic_Managers
       (I_Resource_Trees_Managers,
        Resource_Tree,
        Related_Depth,
        DBA.Resource_Trees,
        Internal_Query_Resource_Trees);
   type Resource_Trees_Managers is new I_Resource_Trees.Manager
   with null record;
   ...
   Empty_Resource_Tree_List        : constant Resource_Tree_List :=
     I_Resource_Trees.Empty_List;
   ...
   package I_Resources is new
     Generic_Managers
       (I_Resources_Managers,
        Resource,
        Related_Depth,
        DBA.Resources,
   ...
   Empty_Resource_List        : constant Resource_List :=
     I_Resources.Empty_List;
   ...
   package I_Resources_Messages is new
     Generic_Managers
       (I_Resources_Messages_Managers,
        Resource_Message,
        Related_Depth,
        DBA.Resources_Messages,
        Internal_Query_Resources_Messages);
   type Resources_Messages_Managers is new I_Resources_Messages.Manager
   with null record;
   subtype Resources_Messages_Stmt is
     I_Resources_Messages.ORM_Prepared_Statement;
   ...
   Empty_Resource_Message_List        : constant Resource_Message_List :=
     I_Resources_Messages.Empty_List;
   Empty_Direct_Resource_Message_List :
     constant Direct_Resource_Message_List :=
       I_Resources_Messages.Empty_Direct_List;

   type I_Rules_Managers is abstract new Manager with null record;
   package I_Rules is new
     Generic_Managers
       (I_Rules_Managers,
        Rule,
        Related_Depth,
   ...
   function Rule_Messages
     (Self : Detached_Rule'Class) return Messages_Managers;
   function Rule_Messages
   ...
   function Get_Message
     (Self : Message'Class) return Resources_Messages_Managers;
   function Get_Message
     (Self : Detached_Message'Class) return Resources_Messages_Managers;
   function Get_Message
   ...
   function Message_Entities
     (Self : Message'Class) return Entities_Messages_Managers;
   function Message_Entities
     (Self : Detached_Message'Class) return Entities_Messages_Managers;
   function Message_Entities
     (Self : I_Messages_Managers'Class) return Entities_Messages_Managers;

   function Message_Properties
     (Self : Message'Class) return Messages_Properties_Managers;
   function Message_Properties
     (Self : Detached_Message'Class) return Messages_Properties_Managers;
   function Message_Properties
   ...
   function Entity_Messages
     (Self : Entity'Class) return Entities_Messages_Managers;
   function Entity_Messages
     (Self : Detached_Entity'Class) return Entities_Messages_Managers;
   function Entity_Messages
   ...
   function Property_Messages
     (Self : Property'Class) return Messages_Properties_Managers;
   function Property_Messages
     (Self : Detached_Property'Class) return Messages_Properties_Managers;
   function Property_Messages
   ...
   function Get_Resource
     (Self : Resource'Class) return Resources_Messages_Managers;
   function Get_Resource
     (Self : Detached_Resource'Class) return Resources_Messages_Managers;
   function Get_Resource
   ...
   function Get_Resource
     (Self : Detached_Resource'Class) return Entities_Managers;
   function Get_Resource
   ...
   function Resource_Children
     (Self : Resource'Class) return Resource_Trees_Managers;
   function Resource_Children
     (Self : Detached_Resource'Class) return Resource_Trees_Managers;
   function Resource_Children
   ...
   overriding
   procedure Free (Self : in out Entity_Ddr);
   overriding
   procedure Free (Self : in out Entity_Message_Ddr);
   overriding
   procedure Free (Self : in out Message_Ddr);
   overriding
   procedure Free (Self : in out Message_Property_Ddr);
   overriding
   procedure Free (Self : in out Property_Ddr);
   overriding
   procedure Free (Self : in out Resource_Tree_Ddr);
   overriding
   procedure Free (Self : in out Resource_Ddr);
   overriding
   procedure Free (Self : in out Resource_Message_Ddr);
   overriding
   procedure Free (Self : in out Rule_Ddr);
   overriding
   procedure Free (Self : in out Tool_Ddr);
   ...
   overriding
   procedure Internal_Delete (Self : Detached_Entity);
   overriding
   procedure Internal_Delete (Self : Detached_Entity_Message);
   overriding
   procedure Internal_Delete (Self : Detached_Message);
   overriding
   procedure Internal_Delete (Self : Detached_Message_Property);
   overriding
   procedure Internal_Delete (Self : Detached_Property);
   overriding
   procedure Internal_Delete (Self : Detached_Resource_Tree);
   overriding
   procedure Internal_Delete (Self : Detached_Resource);
   overriding
   procedure Internal_Delete (Self : Detached_Resource_Message);
   overriding
   procedure Internal_Delete (Self : Detached_Rule);
   overriding
   procedure Internal_Delete (Self : Detached_Tool);

   overriding
   function Key (Self : Entity_Ddr) return Element_Key;
   overriding
   function Key (Self : Entity_Message_Ddr) return Element_Key;
   overriding
   function Key (Self : Message_Ddr) return Element_Key;
   overriding
   function Key (Self : Message_Property_Ddr) return Element_Key;
   overriding
   function Key (Self : Property_Ddr) return Element_Key;
   overriding
   function Key (Self : Resource_Tree_Ddr) return Element_Key;
   overriding
   function Key (Self : Resource_Ddr) return Element_Key;
   overriding
   function Key (Self : Resource_Message_Ddr) return Element_Key;
   overriding
   function Key (Self : Rule_Ddr) return Element_Key;
   overriding
   function Key (Self : Tool_Ddr) return Element_Key;

   overriding
   procedure On_Persist (Self : Detached_Entity);
   overriding
   procedure On_Persist (Self : Detached_Entity_Message);
   overriding
   procedure On_Persist (Self : Detached_Message);
   overriding
   procedure On_Persist (Self : Detached_Message_Property);
   overriding
   procedure On_Persist (Self : Detached_Resource_Tree);
   overriding
   procedure On_Persist (Self : Detached_Resource_Message);
   overriding
   procedure On_Persist (Self : Detached_Rule);
...
private
   ...
   type Detached_Entity is new Sessions.Detached_Element with null record;
   No_Entity          : constant Entity := (No_Orm_Element with null record);
   No_Detached_Entity : constant Detached_Entity :=
     (Sessions.Detached_Element with null record);

   type Detached_Entity_Message is new Sessions.Detached_Element
   with null record;
   No_Entity_Message          : constant Entity_Message :=
   ...
   type Detached_Message is new Sessions.Detached_Element with null record;
   No_Message          : constant Message := (No_Orm_Element with null record);
   No_Detached_Message : constant Detached_Message :=
     (Sessions.Detached_Element with null record);

   type Detached_Message_Property is new Sessions.Detached_Element
   with null record;
   No_Message_Property          : constant Message_Property :=
     (No_Orm_Element with null record);
   No_Detached_Message_Property : constant Detached_Message_Property :=
   ...
   type Detached_Property is new Sessions.Detached_Element with null record;
   No_Property          : constant Property :=
     (No_Orm_Element with null record);
   No_Detached_Property : constant Detached_Property :=
     (Sessions.Detached_Element with null record);

   type Detached_Resource_Tree is new Sessions.Detached_Element
   with null record;
   No_Resource_Tree          : constant Resource_Tree :=
     (No_Orm_Element with null record);
   No_Detached_Resource_Tree : constant Detached_Resource_Tree :=
   ...
   type Detached_Resource is new Sessions.Detached_Element with null record;
   No_Resource          : constant Resource :=
     (No_Orm_Element with null record);
   No_Detached_Resource : constant Detached_Resource :=
     (Sessions.Detached_Element with null record);

   type Detached_Resource_Message is new Sessions.Detached_Element
   with null record;
   No_Resource_Message          : constant Resource_Message :=
     (No_Orm_Element with null record);
   No_Detached_Resource_Message : constant Detached_Resource_Message :=
   ...
   type Detached_Rule is new Sessions.Detached_Element with null record;
   No_Rule          : constant Rule := (No_Orm_Element with null record);
   No_Detached_Rule : constant Detached_Rule :=
     (Sessions.Detached_Element with null record);

   type Detached_Tool is new Sessions.Detached_Element with null record;
