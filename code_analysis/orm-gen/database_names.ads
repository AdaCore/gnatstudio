...
package Database_Names is
   ...
   Ta_Entities_Messages   : constant Cst_String_Access :=
     TC_Entities_Messages'Access;
   ...
   Ta_Messages_Properties : constant Cst_String_Access :=
     TC_Messages_Properties'Access;
   ...
   Ta_Resource_Trees      : constant Cst_String_Access :=
     TC_Resource_Trees'Access;
   ...
   Ta_Resources_Messages  : constant Cst_String_Access :=
     TC_Resources_Messages'Access;
