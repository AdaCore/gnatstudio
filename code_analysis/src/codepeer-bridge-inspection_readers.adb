...
package body CodePeer.Bridge.Inspection_Readers is
   ...
   Command_Line_Main_Attribute              : constant String :=
     "command_line_main";
   Command_Line_Switches_Attribute          : constant String :=
   ...
   Previous_Command_Line_Main_Attribute     : constant String :=
     "previous_command_line_main";
   Previous_Command_Line_Switches_Attribute : constant String :=
     "previous_command_line_switches";
   Previous_Timestamp_Attribute             : constant String :=
     "previous_timestamp";
   Timestamp_Attribute                      : constant String := "timestamp";
   Library_File_Attribute                   : constant String :=
     "library_file";
   ...
   is
      procedure Free is new
        Ada.Unchecked_Deallocation
          (Abstract_Inspection_Reader'Class,
           Inspection_Reader_Access);
   ...
   begin
      ...
      for Item in CodePeer.Lifeage_Kinds'Range loop
         CodePeer.Project_Data'Class (Self.Root_Inspection.all)
           .Lifeage_Subcategories
           .Include (new CodePeer.Lifeage_Kinds'(Item));
      end loop;

      --  Ranking Lifeage kinds
      for Item in CodePeer.Ranking_Kinds'Range loop
         CodePeer.Project_Data'Class (Self.Root_Inspection.all)
           .Ranking_Subcategories
           .Include (new CodePeer.Ranking_Kinds'(Item));
      end loop;
   ...
   is
      ...
      function Get_Value
        (Attrs : Sax.Attributes.Attributes'Class; Local_Name : String)
      ...
      begin
         if Index /= -1 then
            return Ada.Calendar.Formatting.Value (Attrs.Get_Value (Index));
   ...
   begin
      if Self.Ignore_Depth /= 0 then
         ...
         begin
            Data.Current.Inspection := Get_Value (Attrs, Identifier_Attribute);
            ...
            Data.Baseline.Inspection := Get_Value (Attrs, Previous_Attribute);
