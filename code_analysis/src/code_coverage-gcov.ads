...
package Code_Coverage.Gcov is
   ...
   type Gcov_Line_Coverage_Status is
     (No_Code, Not_Covered, Covered, Undetermined);
   ...
   overriding
   function Is_Valid (Self : Gcov_Line_Coverage) return Boolean;
   overriding
   function Print_Status (Self : Gcov_Line_Coverage) return String;
