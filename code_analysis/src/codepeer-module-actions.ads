...
private
   ...
   type CodePeer_Interactive_Command (Module : not null CodePeer_Module_Id) is
      abstract new Interactive_Command
   with null record;
   ...
   type Analyze_All_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Analyze_File_By_File_Command is new Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Display_Code_Review_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Display_Baseline_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Baseline_Bump_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Baseline_Set_Baseline_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Baseline_Set_Current_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Generate_CSV_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Generate_HTML_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Regenerate_Report_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Remove_XML_Review_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Show_Annotations_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Hide_Annotations_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Review_Messages_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Annotate_Messages_Command is new CodePeer_Interactive_Command
   with null record;
   overriding
   function Execute
   ...
   type Is_Hide_Annotations_Filter
     (Module : not null CodePeer.Module.CodePeer_Module_Id)
