...
package CodePeer.Module is
   ...
   is new GPS.Kernel.Modules.Module_ID_Record with private;
   ...
   procedure Annotate_Message
     (Self : access Module_Id_Record'Class; Message : CodePeer.Message_Access);
   ...
   function Get_Messages
     (Self     : access Module_Id_Record'Class;
      ...
      Messages : out CodePeer.Message_Vectors.Vector) return Boolean;
   ...
   type Submenu_Factory_Record (Module : access Module_Id_Record'Class) is
   ...
   function CodePeer_Category_Name return VSS.Strings.Virtual_String
   is (CodePeer.Module_Name & ": messages");
   ...
   function Create_CodePeer_Message
     (Id          : Natural;
      ...
      GNATSAS_Id  : GNATSAS_Id_Access) return Message_Access;
...
private
   ...
   type Module_Id_Record
     (Kernel : access GPS.Kernel.Kernel_Handle_Record'Class)
   is new GPS.Kernel.Modules.Module_ID_Record with record
   ...
   function Codepeer_Server_URL (Project : Project_Type) return String;
   ...
   overriding
   procedure Initialize (Self : in out CodePeer_Build_Mode);
   overriding
   procedure Finalize (Self : in out CodePeer_Build_Mode);
