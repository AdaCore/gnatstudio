      ...
      Module.Import_Annotations :=
        Default_Preferences.Create
          (Kernel.Get_Preferences,
           ...
           Doc     => -("Controls whether to import and display GNAT SAS"
             & " annotations generated by Inspector analysis such as"
             & " generated contracts and values of variables in the source"
             & " editor. Note that importing GNAT SAS annotations can take"
             & " a significant amount of time for large projects."),
           Default => True);
