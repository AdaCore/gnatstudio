...
generic
   ...
   Is_Visible :
     access function
       (Item : Item_Access; View : Gtk.Widget.Gtk_Widget) return Boolean :=
       null;
   --  Should be used for filtration if set

package GNAThub.Generic_Criteria_Editors
is
   ...
   function Item_By_Path
     (Self : access Criteria_Editor_Record'Class;
      Path : Gtk.Tree_Model.Gtk_Tree_Path) return Item_Access;
   --  Return Item by Path
...
private
   ...
   function Filter_Visible_Func
     (Model : Gtk.Tree_Model.Gtk_Tree_Model;
      ...
      View  : Gtk.Widget.Gtk_Widget) return Boolean;

   package Set_Visible_Func_With_Data is new
     Gtk.Tree_Model_Filter.Set_Visible_Func_User_Data (Gtk.Widget.Gtk_Widget);

   Visible :
     constant Set_Visible_Func_With_Data.Gtk_Tree_Model_Filter_Visible_Func :=
       Filter_Visible_Func'Access;
