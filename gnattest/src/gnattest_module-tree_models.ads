...
package GNATTest_Module.Tree_Models is
   ...
   procedure Gtk_New (Model : out Tree_Model; Data : Source_Entity_Maps.Map);

   procedure Initialize
     (Self : access Tree_Model_Record'Class; Data : Source_Entity_Maps.Map);

   overriding
   function Get_N_Columns (Self : access Tree_Model_Record) return Glib.Gint;
...
private
   ...
   package Index_Ordered_Maps is new
