...
package body Main_Debug_Window_Pkg is
   ...
   begin
      ...
      Return_Callback.Connect
        (Main_Debug_Window, "delete_event",
         On_Main_Debug_Window_Delete_Event'Access);
      ...
      Pack_Start
        (Main_Debug_Window.Vbox, Main_Debug_Window.Toolbar_Box,
         False, False, 0);

      Gtk_New (Main_Debug_Window.Statusbar);
      Pack_End
        (Main_Debug_Window.Vbox, Main_Debug_Window.Statusbar, False, False, 0);
   end Initialize;
