...
package GPS.Kernel.Search.Filenames is
   ...
   type Filenames_Search_Provider is new Kernel_Search_Provider with private;

   overriding
   procedure Free (Self : in out Filenames_Search_Provider);
   overriding
...
private
   ...
   overriding
   procedure Execute
     (Self : not null access Filenames_Search_Result; Give_Focus : Boolean);
   overriding
   function Full
