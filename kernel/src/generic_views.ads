...
package Generic_Views is
   ...
   procedure Save_To_XML
     (View : access View_Record; XML : in out XML_Utils.Node_Ptr)
   is null;
   ...
   procedure Load_From_XML
     (View : in out View_Record; XML : XML_Utils.Node_Ptr)
   is null;
   ...
   procedure On_Destroy (View : not null access View_Record) is null;
   ...
   procedure Set_Filter (Self : not null access View_Record; Text : String);
   ...
   procedure Set_Activity_Progress_Bar_Visibility
     (Self : not null access View_Record'Class; Visible : Boolean);
   ...
   generic
      ...
      with
        function Initialize
          (View : access Formal_View_Record'Class) return Gtk.Widget.Gtk_Widget
        is <>;
   ...
   is
      ...
      function Create_Finalized_View
        (View       : not null access Formal_View_Record'Class;
         Toolbar_Id : String := View_Name) return Gtk.Widget.Gtk_Widget;
   ...
   private
      ...
      Load_Desktop_Access : constant GPS.Kernel.MDI.Load_Desktop_Function :=
        Load_Desktop'Access;
      ...
      On_Display_Local_Config_Access :
        constant Gtk.Widget.Cb_GObject_Gdk_Event_Button_Boolean :=
          On_Display_Local_Config'Access;
      --  Called to display the local config menu

      procedure On_Float_Child
        (Child : access Gtk.Widget.Gtk_Widget_Record'Class);
      On_Float_Child_Access :
      ...
      On_Delete_Floating_Child_Access :
        constant Gtkada.Handlers.Return_Callback.Simple_Handler :=
