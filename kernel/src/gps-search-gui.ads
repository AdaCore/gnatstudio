...
package GPS.Search.GUI is
   ...
   type Overall_Search_Provider_Access is
     access all Overall_Search_Provider'Class;
   ...
   overriding
   procedure Free (Self : in out Overall_Search_Provider);
   overriding
   ...
   type Global_Search_Command_Access is access all Global_Search_Command'Class;
   overriding
   function Execute
...
private
   ...
   overriding
   procedure Reset_Progress (Self : not null access Overall_Search_Provider);
