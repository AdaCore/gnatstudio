...
package Default_Preferences.GUI is
   ...
   type Preferences_Group_Widget_Record is
     new Dialog_Group_Widget_Record with private;
   ...
   type Preferences_Page_View_Record is new Dialog_View_Record with private;
