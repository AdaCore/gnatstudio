...
package GPS.Kernel.Scripts is
   ...
   function Get_Entity_Class
     (Kernel : access GPS.Core_Kernels.Core_Kernel_Record'Class)
      return Class_Type
   renames GPS.Scripts.Entities.Get_Entity_Class;
   ...
   renames GPS.Scripts.Entities.Get_Data;
   ...
   renames GPS.Scripts.Entities.Create_Entity;
   ...
   function Get_File_Class
     (Kernel : access GPS.Core_Kernels.Core_Kernel_Record'Class)
      return Class_Type
   renames GPS.Scripts.Files.Get_File_Class;
   ...
   renames GPS.Scripts.Files.Nth_Arg;
   procedure Set_Nth_Arg
     (Data : in out Callback_Data'Class;
      N    : Positive;
      File : GNATCOLL.VFS.Virtual_File)
   renames GPS.Scripts.Files.Set_Nth_Arg;
   function Get_Data
     (Instance : Class_Instance) return GNATCOLL.VFS.Virtual_File
   renames GPS.Scripts.Files.Get_Data;
   ...
   renames GPS.Scripts.Files.Create_File;
   --  Return a new file
