...
package GPS.Kernel.Search.Actions is
   ...
   type Actions_Search_Provider is new Kernel_Search_Provider with private;
   overriding
   ...
   overriding
   procedure Free (Self : in out Actions_Search_Result);

private

   type Actions_Search_Module_ID_Record is new Module_ID_Record
   with null record;
