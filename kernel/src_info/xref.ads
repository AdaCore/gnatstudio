...
package Xref is
   ...
   function Parameters (Entity : Root_Entity) return Parameter_Array
   is abstract;
   ...
   type Extended_Xref_Database is new GNATCOLL.Xref.Xref_Database with private;
   ...
   No_Location : aliased constant General_Location := (No_File, No_File, 0, 0);
   ...
   package Lang_Specific_Databases_Maps is new
   ...
   type Reference_Kind_Filter is
     access function (Ref : Root_Entity_Reference'Class) return Boolean;

   function From_Instances (Ref : Root_Entity_Reference) return Entity_Array
   is abstract;
   function Reference_Is_Body (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Reference_Is_Declaration
     (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Is_Real_Reference (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Is_Implicit_Reference (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Is_Real_Or_Implicit_Reference
     (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Is_Read_Reference (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Is_Write_Reference (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   ...
   function Is_Read_Or_Write_Or_Implicit_Reference
     (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Get_Entity (Ref : Root_Entity_Reference) return Root_Entity'Class
   is abstract;
   function Get_Entity_Name (Ref : Root_Entity_Reference) return String
   is abstract;
   function Get_Location (Ref : Root_Entity_Reference) return General_Location
   is abstract;
   function Show_In_Callgraph (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Is_Dispatching_Call (Ref : Root_Entity_Reference) return Boolean
   is abstract;
   function Get_Display_Kind (Ref : Root_Entity_Reference) return String
   is abstract;
   ...
   is abstract;
   function Get_Caller (Ref : Root_Entity_Reference) return Root_Entity'Class
   is abstract;
   ...
   function Get_Entity
     (Iter : Root_Reference_Iterator) return Root_Entity'Class
   is abstract;

   procedure Destroy (Iter : in out Root_Reference_Iterator) is abstract;

   function Get_Current_Progress
     (Iter : Root_Reference_Iterator) return Integer
   is abstract;

   function Get_Total_Progress (Iter : Root_Reference_Iterator) return Integer
   is abstract;
   ...
   overriding
   function "=" (Ref1, Ref2 : General_Entity_Reference) return Boolean;
   ...
   function Get_Name (Entity : Root_Entity) return String is abstract;
   --  Return the name of the entity

   function Get_Display_Kind (Entity : Root_Entity) return String is abstract;
   ...
   function Qualified_Name (Entity : Root_Entity) return String is abstract;
   --  Return the fully qualified name of the entity

   function Hash (Entity : Root_Entity) return Integer is abstract;
   --  Return a hash code for the entity

   function Cmp (Entity1, Entity2 : Root_Entity'Class) return Integer;
   --  Return -1, 0 or 1 to sort the two entities

   function Get_Declaration
     (Entity : Root_Entity) return General_Entity_Declaration
   is abstract;
   --  Return the location of the entity declaration

   function Caller_At_Declaration
     (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  Return the entity whose scope contains the declaration of Entity

   function Get_Body
     (Entity : Root_Entity; After : General_Location := No_Location)
      return General_Location
   is abstract;
   --  Return the location of the first body for this entity

   function Get_Type_Of (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  Return the type of the entity

   function Returned_Type (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  Return the type returned by a function.

   function Parent_Package (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  Return the parent package (if Entity is a package itself)

   function Pointed_Type (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  The type pointed to by an access type. Returns null for a variable.

   function Renaming_Of (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  Return the entity that Entity renames (or No_General_Entity)

   function Is_Primitive_Of (Entity : Root_Entity) return Entity_Array
   is abstract;
   ...
   function Requires_Body (E : Root_Entity) return Boolean is abstract;
   ...
   function Is_Abstract (E : Root_Entity) return Boolean is abstract;
   --  Whether the entity is abstract (ie cannot be instantiated

   function Is_Array (E : Root_Entity) return Boolean is abstract;
   ...
   function Is_Printable_In_Debugger (E : Root_Entity) return Boolean
   is abstract;
   ...
   function Is_Type (E : Root_Entity) return Boolean is abstract;
   --  True f E is a type (not a variable or a package for instance)

   function Is_Subprogram (E : Root_Entity) return Boolean is abstract;
   --  True if E is a subprogram

   function Is_Container (E : Root_Entity) return Boolean is abstract;
   --  True if E can contain other entities (a record, struct,...)

   function Is_Generic (E : Root_Entity) return Boolean is abstract;
   --  Whether the entity is a 'generic' or 'template'

   function Is_Global (E : Root_Entity) return Boolean is abstract;
   --  Whether the entity is a global entity (library-level in Ada)

   function Is_Static_Local (E : Root_Entity) return Boolean is abstract;
   --  Whether the entity is a static, in the C/C++ sense.

   function Is_Predefined_Entity (E : Root_Entity) return Boolean is abstract;
   ...
   function End_Of_Scope (Entity : Root_Entity) return General_Location
   is abstract;
   ...
   function Is_Parameter_Of (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  Return the subprogram for which entity is a parameter

   function Overrides (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  The entity that Entity overrides.

   function Instance_Of (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  Return the generic entity instantiated by Entity

   function Methods
     (Entity : Root_Entity; Include_Inherited : Boolean) return Entity_Array
   is abstract;
   --  The list of methods of an entity.

   function Fields (Entity : Root_Entity) return Entity_Array is abstract;
   --  The fields of an Ada record or C struct

   function Literals (Entity : Root_Entity) return Entity_Array is abstract;
   --  Return the literals of an enumeration

   function Formal_Parameters (Entity : Root_Entity) return Entity_Array
   is abstract;
   --  The formal parameters for a generic entity.

   function Discriminant_Of (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   --  Return the Ada record for which Entity is a discriminant

   function Discriminants (Entity : Root_Entity) return Entity_Array
   is abstract;
   --  Return the list of discriminants for the entity

   function Component_Type (Entity : Root_Entity) return Root_Entity'Class
   is abstract;
   function Index_Types (Entity : Root_Entity) return Entity_Array is abstract;
   --  Index and components types for an array

   function Child_Types
     (Entity : Root_Entity; Recursive : Boolean) return Entity_Array
   is abstract;
   ...
   function At_End (Iter : Abstract_Entities_Cursor) return Boolean
   is abstract;
   function Get (Iter : Abstract_Entities_Cursor) return Root_Entity'Class
   is abstract;
   ...
   function Get_All_Called_Entities
     (Entity : Root_Entity) return Abstract_Entities_Cursor'Class
   is abstract;
   ...
   overriding
   function "=" (E1, E2 : General_Entity) return Boolean;
   ...
   package Root_Entity_Reference_Refs is new
     Ada.Containers.Indefinite_Holders (Root_Entity_Reference'Class);
   ...
   overriding
   function Get_Entity_Name (Ref : General_Entity_Reference) return String
   ...
   overriding
   function Get_Display_Kind (Ref : General_Entity_Reference) return String;
   ...
   overriding
   procedure Destroy (Iter : in out Base_Entities_Cursor) is null;
   ...
   overriding
   function At_End (Iter : Entities_In_File_Cursor) return Boolean;
   overriding
   function Get (Iter : Entities_In_File_Cursor) return Root_Entity'Class;
   overriding
   procedure Next (Iter : in out Entities_In_File_Cursor);
   ...
   overriding
   function At_End (Iter : Entities_In_Project_Cursor) return Boolean;
   overriding
   function Get (Iter : Entities_In_Project_Cursor) return Root_Entity'Class;
   overriding
   procedure Next (Iter : in out Entities_In_Project_Cursor);
   ...
   overriding
   function Get (Iter : Calls_Iterator) return Root_Entity'Class;
   overriding
   ...
   package Root_Entity_Refs is new
     Ada.Containers.Indefinite_Holders (Root_Entity'Class);

   package Root_Reference_Iterator_Refs is new
     Ada.Containers.Indefinite_Holders (Root_Reference_Iterator'Class);

   subtype Root_Entity_Ref is Root_Entity_Refs.Holder;
   subtype Root_Reference_Iterator_Ref is Root_Reference_Iterator_Refs.Holder;
...
private
   ...
   overriding
   function Get_Name (Entity : General_Entity) return String;
   overriding
   function Get_Display_Kind (Entity : General_Entity) return String;
   overriding
   function Qualified_Name (Entity : General_Entity) return String;
   overriding
   function Hash (Entity : General_Entity) return Integer;
   ...
   function Get_Body
     (Entity : General_Entity; After : General_Location := No_Location)
      return General_Location;
   overriding
   function Get_Type_Of (Entity : General_Entity) return Root_Entity'Class;

   overriding
   function Returned_Type (Entity : General_Entity) return Root_Entity'Class;

   overriding
   function Parent_Package (Entity : General_Entity) return Root_Entity'Class;
   overriding
   function Pointed_Type (Entity : General_Entity) return Root_Entity'Class;
   overriding
   function Renaming_Of (Entity : General_Entity) return Root_Entity'Class;
   overriding
   function Is_Primitive_Of (Entity : General_Entity) return Entity_Array;

   overriding
   function Has_Methods (E : General_Entity) return Boolean;

   overriding
   function Requires_Body (E : General_Entity) return Boolean;

   overriding
   function Is_Access (E : General_Entity) return Boolean;
   overriding
   function Is_Abstract (E : General_Entity) return Boolean;
   overriding
   function Is_Array (E : General_Entity) return Boolean;

   overriding
   function Is_Printable_In_Debugger (E : General_Entity) return Boolean;

   overriding
   function Is_Type (E : General_Entity) return Boolean;
   overriding
   function Is_Subprogram (E : General_Entity) return Boolean;
   --  True if E is a subprogram

   overriding
   function Is_Container (E : General_Entity) return Boolean;
   overriding
   function Is_Generic (E : General_Entity) return Boolean;

   overriding
   function Is_Global (E : General_Entity) return Boolean;
   overriding
   function Is_Static_Local (E : General_Entity) return Boolean;
   overriding
   function Is_Predefined_Entity (E : General_Entity) return Boolean;
   ...
   overriding
   function End_Of_Scope (Entity : General_Entity) return General_Location;

   overriding
   function Is_Parameter_Of (Entity : General_Entity) return Root_Entity'Class;

   overriding
   function Overrides (Entity : General_Entity) return Root_Entity'Class;

   overriding
   function Instance_Of (Entity : General_Entity) return Root_Entity'Class;

   overriding
   function Methods
     (Entity : General_Entity; Include_Inherited : Boolean)
      return Entity_Array;

   overriding
   function Fields (Entity : General_Entity) return Entity_Array;

   overriding
   function Literals (Entity : General_Entity) return Entity_Array;

   overriding
   function Formal_Parameters (Entity : General_Entity) return Entity_Array;
   overriding
   function Discriminant_Of (Entity : General_Entity) return Root_Entity'Class;
   overriding
   function Discriminants (Entity : General_Entity) return Entity_Array;

   overriding
   function Component_Type (Entity : General_Entity) return Root_Entity'Class;
   overriding
   function Index_Types (Entity : General_Entity) return Entity_Array;
   ...
   overriding
   function Parameters (Entity : General_Entity) return Parameter_Array;

   No_Root_Entity_Reference : aliased constant Root_Entity_Reference'Class :=
     General_Entity_Reference'
       (Db => null, Ref => GNATCOLL.Xref.No_Entity_Reference);
   ...
   type GPS_Recursive_References_Cursor is
     new GNATCOLL.Xref.Recursive_References_Cursor
   with record
      Include_Implicit : Boolean := False;
      Include_All      : Boolean := False;
   ...
   No_General_Entity : aliased constant General_Entity :=
     (Is_Fuzzy => False, Loc => No_Location, Entity => No_Entity, Db => null);
   ...
   No_Root_Entity : aliased constant Root_Entity'Class := No_General_Entity;
   ...
   overriding
   function At_End (Iter : Dummy_Entities_Cursor) return Boolean
   is (True);

   overriding
   function Get (Iter : Dummy_Entities_Cursor) return Root_Entity'Class
   is (No_Root_Entity);

   overriding
   procedure Next (Iter : in out Dummy_Entities_Cursor) is null;

   overriding
   procedure Destroy (Iter : in out Dummy_Entities_Cursor) is null;
   ...
   overriding
   function At_End (Iter : Dummy_Reference_Iterator) return Boolean
   is (True);
   --  Whether there are no more reference to return

   overriding
   procedure Next (Iter : in out Dummy_Reference_Iterator) is null;
   --  Move to the next reference to the entity
   ...
   overriding
   procedure Destroy (Iter : in out Dummy_Reference_Iterator) is null;

   overriding
   function Get_Current_Progress
     (Iter : Dummy_Reference_Iterator) return Integer
   is (0);

   overriding
   function Get_Total_Progress (Iter : Dummy_Reference_Iterator) return Integer
   is (0);
