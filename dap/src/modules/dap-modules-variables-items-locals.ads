...
package DAP.Modules.Variables.Items.Locals is
   ...
   overriding
   function Get_Special_Kind (Info : Locals_Item_Info) return Variable_Kind;

   overriding
   function Get_Name (Self : Locals_Item_Info) return Virtual_String;

   overriding
   function Get_Full_Name (Self : Locals_Item_Info) return Virtual_String;
   ...
   overriding
   procedure Store
     (Info : Locals_Item_Info; Value : in out GNATCOLL.JSON.JSON_Value);
