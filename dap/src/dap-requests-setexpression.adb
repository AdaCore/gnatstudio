...
package body DAP.Requests.SetExpression is
   ...
   begin
      DAP.Tools.Outputs.Output_SetExpressionRequest (Stream, Self.Parameters);
   end Write;
   ...
   begin
      ...
      if Success then
         Set_Expression_DAP_Request'Class (Self).On_Result_Message
