...
package body DAP.Requests.Pause is
   ...
   begin
      ...
      if Success then
         Pause_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq (Self : in out Pause_DAP_Request; Id : Integer) is
   begin
      Self.Parameters.seq := Id;
   end Set_Seq;

end DAP.Requests.Pause;
