...
package body DAP.Clients.Disconnects is
   ...
   begin
      DAP.Requests.Disconnects.On_Rejected
        (DAP.Requests.Disconnects.Disconnect_DAP_Request (Self), Client);
   ...
   begin
      DAP.Requests.Disconnects.On_Error_Message
        (DAP.Requests.Disconnects.Disconnect_DAP_Request (Self),
         Client, Message);

      Client.On_Disconnected;
   end On_Error_Message;

end DAP.Clients.Disconnects;
