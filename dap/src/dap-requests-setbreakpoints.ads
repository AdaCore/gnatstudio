...
package DAP.Requests.SetBreakpoints is
   ...
   overriding
   procedure Set_Seq (Self : in out Breakpoint_DAP_Request; Id : Integer);

   overriding
   function Method (Self : in out Breakpoint_DAP_Request) return String
   is ("setBreakpoints");

end DAP.Requests.SetBreakpoints;
