...
package DAP.Clients.Loaded_Sources is

   type Loaded_Sources_Request (<>) is
     new DAP.Requests.Loaded_Sources.Loaded_Sources_DAP_Request
   with private;
...
private
   ...
   type Loaded_Sources_Request is
     new DAP.Requests.Loaded_Sources.Loaded_Sources_DAP_Request with
       null record;
