...
package body DAP.Requests.WriteMemory is
   ...
   begin
      ...
      if Success then
         Write_Memory_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq (Self : in out Write_Memory_DAP_Request; Id : Integer) is
   begin
