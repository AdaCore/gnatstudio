...
package body DAP.Requests.SetExceptionBreakpoints is

   Me : constant Trace_Handle :=
     Create ("GPS.DAP.Requests_Exception_Breakpoints", On);
   ...
   begin
      ...
      if Success then
         Exception_Breakpoints_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq
     (Self : in out Exception_Breakpoints_DAP_Request; Id : Integer) is
   begin
