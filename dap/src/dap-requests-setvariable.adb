...
package body DAP.Requests.SetVariable is
   ...
   begin
      ...
      if Success then
         Set_Variable_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq (Self : in out Set_Variable_DAP_Request; Id : Integer) is
   begin
