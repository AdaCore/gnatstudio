...
package body DAP.Requests.ReadMemory is

   Me : constant Trace_Handle := Create ("GPS.DAP.Read_Memory_Request", On);
   ...
   begin
      ...
      if Success then
         Read_Memory_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq (Self : in out Read_Memory_DAP_Request; Id : Integer) is
   begin
      Self.Parameters.seq := Id;
   end Set_Seq;

end DAP.Requests.ReadMemory;
