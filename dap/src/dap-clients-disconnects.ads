...
package DAP.Clients.Disconnects is

   type Disconnect_Request (<>) is
     new DAP.Requests.Disconnects.Disconnect_DAP_Request with private;
...
private
   ...
   type Disconnect_Request is
     new DAP.Requests.Disconnects.Disconnect_DAP_Request with null record;
