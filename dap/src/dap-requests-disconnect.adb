...
package body DAP.Requests.Disconnect is
   ...
   begin
      ...
      if Success then
         Disconnect_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq (Self : in out Disconnect_DAP_Request; Id : Integer) is
   begin
