...
package body DAP.Requests.Evaluate is
   ...
   begin
      ...
      if Success then
         Evaluate_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq (Self : in out Evaluate_DAP_Request; Id : Integer) is
   begin
