...
package body DAP.Requests.Disassemble is
   ...
   begin
      ...
      if Success then
         Disassemble_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq (Self : in out Disassemble_DAP_Request; Id : Integer) is
   begin
