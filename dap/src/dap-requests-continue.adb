...
package body DAP.Requests.Continue is
   ...
   begin
      ...
      if Success then
         Continue_DAP_Request'Class (Self).On_Result_Message
   ...
   overriding
   procedure Set_Seq (Self : in out Continue_DAP_Request; Id : Integer) is
   begin
