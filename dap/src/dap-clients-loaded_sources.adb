...
package body DAP.Clients.Loaded_Sources is
   ...
   begin
      DAP.Requests.Loaded_Sources.On_Rejected
        (DAP.Requests.Loaded_Sources.Loaded_Sources_DAP_Request (Self),
         Client);
   ...
   begin
      DAP.Requests.Loaded_Sources.On_Error_Message
        (DAP.Requests.Loaded_Sources.Loaded_Sources_DAP_Request (Self),
         Client, Message);
...
end DAP.Clients.Loaded_Sources;
