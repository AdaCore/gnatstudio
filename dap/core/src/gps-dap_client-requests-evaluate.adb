...
package body GPS.DAP_Client.Requests.Evaluate is

   overriding procedure Write
     (Self   : Evaluate_Request;
      Stream : in out VSS.JSON.Content_Handlers.JSON_Content_Handler'Class) is
   begin
      DAP.Tools.Outputs.Output_EvaluateRequest (Stream, Self.Parameters);
   end Write;
   ...
   begin
      ...
      if Success then
         Evaluate_Request'Class (Self).On_Result_Message
