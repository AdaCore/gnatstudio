...
package GPS.DAP_Client.Requests.Set_Variable is

   type Set_Variable_Request is abstract new Request with record
   ...
   procedure On_Result_Message
     (Self        : in out Set_Variable_Request;
      Response    : in out DAP.Tools.SetVariableResponse;
   ...
   overriding function Method
     (Self : in out Set_Variable_Request) return String is ("setVariable");
