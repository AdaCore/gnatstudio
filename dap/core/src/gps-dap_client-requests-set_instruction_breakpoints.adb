...
package body GPS.DAP_Client.Requests.Set_Instruction_Breakpoints is

   overriding procedure Write
     (Self   : Set_Instruction_Breakpoints_Request;
      Stream : in out VSS.JSON.Content_Handlers.JSON_Content_Handler'Class) is
   begin
      DAP.Tools.Outputs.Output_SetInstructionBreakpointsRequest
   ...
   overriding procedure On_Result_Message
     (Self        : in out Set_Instruction_Breakpoints_Request;
      ...
      Response : DAP.Tools.SetInstructionBreakpointsResponse;
   begin
      New_Request := null;

      DAP.Tools.Inputs.Input_SetInstructionBreakpointsResponse
        (Stream, Response, Success);

      if Success then
         Set_Instruction_Breakpoints_Request'Class (Self).On_Result_Message
