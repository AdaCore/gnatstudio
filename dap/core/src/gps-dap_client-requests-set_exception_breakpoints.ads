...
package GPS.DAP_Client.Requests.Set_Exception_Breakpoints is

   type Set_Exception_Breakpoints_Request is abstract new Request with record
   ...
   procedure On_Result_Message
     (Self        : in out Set_Exception_Breakpoints_Request;
      Response    : in out DAP.Tools.SetExceptionBreakpointsResponse;
   ...
   overriding function Method
     (Self : in out Set_Exception_Breakpoints_Request) return String is
