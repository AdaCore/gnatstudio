...
package GDT.JNI_Functions is
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_ConstructAccess_getSlocEndInt");
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_ConstructAccess_getNextInt");
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_ConstructAccess_getCategoryInt");
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_ConstructAccess_getNameInt");
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_ConstructList_getFirstInt");
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_ConstructList_getCurrentInt");
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_SourceLocation_getLineInt");
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_SourceLocation_getColumnInt");
   ...
   pragma Export
     (C,
      ...
      "Java_com_adacore_gdt_study_gpsjni_SourceLocation_getIndexInt");
