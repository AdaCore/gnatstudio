...
package body Dualcompilation is

   type Dualcompilation_Property_Record is record
      Active        : Boolean       := False;
      Tools_Path    : String_Access := null;
      Compiler_Path : String_Access := null;
   end record;

   Property : Dualcompilation_Property_Record;
   ...
   ------------------------------------
   -- Set_Dualcompilation_Properties --
   ------------------------------------
   ...
   function Is_Dualcompilation_Active return Boolean is
   begin
