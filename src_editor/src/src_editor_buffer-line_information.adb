            ...
            when Editable =>
               ...
               declare
                  Line_Data : constant Editable_Line_Data :=
                    (Where          => In_Buffer,
                     Side_Info_Data => Editable_Lines (Current).Side_Info_Data,
