...
package Src_Editor_View.Commands is
   ...
   type Add_String_Comment_Command is new Interactive_Command with null record;
   overriding
   function Execute
   ...
   type Split_String_Command is new Interactive_Command with null record;
   overriding
   function Execute
   ...
   type Paste_Into_String_Command is new Interactive_Command with null record;
   overriding
   function Execute
