...
package Commands.Editor is
   ...
   function Debug_String (C : Base_Editor_Command_Type) return String
   is abstract;
   ...
   type Remove_Blank_Lines_Command is
     access all Remove_Blank_Lines_Command_Type;
   ...
   overriding
   function Execute
     (Command : access Hide_Editable_Lines_Type) return Command_Return_Type;
   ...
   overriding
   function Debug_String (C : Editor_Command_Type) return String;
   ...
   procedure Set_End_Location
     (Command : access Editor_Command_Type; Cursor_Loc, Sel_Loc : Loc_T);

   procedure Set_End_Location
     (Command : access Editor_Command_Type; Position : Gtk_Text_Iter);

   overriding
   procedure Primitive_Free (X : in out Remove_Blank_Lines_Command_Type);
   --  Free memory associated to X

   overriding
   function Debug_String (C : Hide_Editable_Lines_Type) return String;
   overriding
   function Debug_String (C : Unhide_Editable_Lines_Type) return String;
   ...
   overriding
   function Execute
     (Command : access Update_Async_Record) return Command_Return_Type;
   --  Request an asynchronous update of the semantic tree

   overriding
   function Name (Command : access Update_Async_Record) return String;
...
private
   ...
   type Editor_Command_Type is new Base_Editor_Command_Type with record
      ...
      Linked_Cursor : Cursors_Holders.Holder := Cursors_Holders.Empty_Holder;
   ...
   overriding
   function Debug_String (C : Check_Modified_State_Type) return String;

   overriding
   function Debug_String (C : Editor_Replace_Slice_Type) return String;
