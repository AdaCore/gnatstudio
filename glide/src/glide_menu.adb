   ...
   begin
      return new Gtk_Item_Factory_Entry_Array'
        (Gtk_New (-"/_File", Item_Type => Branch),
         ...
         Gtk_New (-"/_Search/Goto/Start Of Statement", "", null),
         Gtk_New (-"/_Search/Goto/End Of Statement", "", null),
         Gtk_New (-"/_Search/Goto/Next Procedure", "", null),
         Gtk_New (-"/_Search/Goto/Previous Procedure", "", null),
         ...
         Gtk_New (-"/_Project/Browse Project", "", null),
         Gtk_New (-"/_Project/Task Manager", "", null),

         Gtk_New (-"/_Devel", Item_Type => Branch),
         Gtk_New (-"/_Devel/Check File", "", null),
         Gtk_New (-"/_Devel/Compile File", "", null),
         Gtk_New (-"/_Devel/Build", "", On_Build'Access),
         Gtk_New (-"/_Devel/Build Library", "", On_Build'Access),
         Gtk_New (-"/_Devel/Run", "", null),
         Gtk_New (-"/_Devel/Debug", "", null),
         Gtk_New (-"/_Devel/Profile", "", null),
         Gtk_New (-"/_Devel/Memory Analyzer", "", null),
