    ...
    <target-model name="generate_scil" category="">
       ...
       <switches command="%(tool_name)s" columns="2" lines="3">
         ...
         <spin label="Multiprocessing" switch="-j" min="0" max="1000"
               ...
               tip="Use N processes to carry out the processing (0 means use as many cores as available on the machine)." />
         ...
         <check label="Unconstrained float overflow" switch="-gnateF" column="2"
         ...
         <check label="Generate CodePeer messages" switch="-gnateC" column="2"
                tip="Generate CodePeer messages in compiler format, without creating/updating the database" />
       </switches>
    </target-model>
    ...
    <target-model name="codepeer" category="">
       ...
       <switches command="%(tool_name)s" columns="3" lines="4">
         ...
         <check label="Re-partition" switch="-repartition"
                column="1" tip="Recompute partition libraries instead of reusing partitions from previous run (ignored with -level 4)" />
