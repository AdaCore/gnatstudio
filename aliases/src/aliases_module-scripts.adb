...
package body Aliases_Module.Scripts is
   ...
   begin
      if Alias /= No_Alias then
         Set_Data (Alias_Instance, Target_Class, Alias_Name);
         Set_Property (Alias_Instance, "name", Alias.Get_Name);
         Set_Property (Alias_Instance, "expansion", Alias.Get_Expansion);
