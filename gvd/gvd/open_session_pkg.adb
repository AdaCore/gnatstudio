...
package body Open_Session_Pkg is
   ...
   procedure Append_Button (Open  : access Open_Session_Record'Class;
                            Label : in String);
   ...
   begin
      ...
      Gtk_New_Hbox (Open_Session.Hbox7, False, 10);
      ...
      Pack_Start (Open_Session.Vbox18,
      ...
      Pack_Start (Open_Session.Hbox7,
                  Open_Session.Vseparator4, False, False, 0);
      ...
      Pack_Start (Open_Session.Vbox19,
                  Open_Session.Scrolledwindow11, True, True, 0);
      Set_Policy (Open_Session.Scrolledwindow11,
                  Policy_Automatic, Policy_Automatic);
      ...
      Pack_Start (Open_Session.Vbox19,
                  Open_Session.Hbuttonbox10, False, False, 0);
      ...
      Gtk_New (Open_Session.Unselect_All, -"Unselect_All");
      ...
      Pack_Start (Open_Session.Vbox17,
                  Open_Session.Hseparator1, False, False, 0);

      Gtk_New (Open_Session.Hbuttonbox9);
      Pack_Start (Open_Session.Vbox17,
                  Open_Session.Hbuttonbox9, False, False, 0);
   ...
   begin
      ...
      if Get_Text (Open.Entry1) /= "" then
         ...
         Ada.Text_IO.Open (File, In_File, Open.Sessions_Dir.all
               & Directory_Separator & Get_Text (Open.Entry1));
   ...
   begin
      ...
      Pack_Start (Open.File_Buttons,
                  Button, False, False, 0);
      Set_Active (Button, True);
      Show_All (Button);

      if Open.First_Button = null then
         Open.First_Button := new Button_Node' (Next   => null,
                                                Button => Button,
         ...
         Buffer.Next := new Button_Node' (Next   => null,
                                          Button => Button,
                                          Label  => new String' (Label));
      end if;
