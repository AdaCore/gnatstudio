...
package body Memory_View_Pkg is
   ...
   begin
      ...
      Pack_Start
        (Memory_View.Vbox24, Memory_View.Address_Entry, False, False, 0);
      ...
      Pack_Start
        (Memory_View.Vbox24, Memory_View.Search_Entry, False, False, 0);
      ...
      Pack_Start
        (Memory_View.Hbox8, Memory_View.Vbuttonbox6, False, False, 0);
      ...
      Pack_Start
        (Memory_View.Hbox12, Memory_View.Vbuttonbox5, False, False, 0);
      ...
      Pack_Start
        (Memory_View.Hbox12, Memory_View.Vseparator7, False, True, 10);
      ...
      Pack_Start
        (Memory_View.Vbox20, Memory_View.Scrolledwindow, True, True, 0);
      ...
      Pack_Start
        (Memory_View.Vbox20, Memory_View.Hseparator2, False, False, 3);
      ...
      Pack_Start
        (Memory_View.Vbox20, Memory_View.Hbuttonbox11, False, False, 0);
      ...
      Pack_Start
        (Memory_View.Vbox20, Memory_View.Memory_Status_Bar, False, False, 0);
   end Initialize;
