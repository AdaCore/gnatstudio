...
private
   ...
   pragma Import (C, stock_add_xpm, "stock_add_xpm");
   pragma Import (C, stock_button_apply_xpm, "stock_button_apply_xpm");
   pragma Import (C, stock_button_cancel_xpm, "stock_button_cancel_xpm");
   pragma Import (C, stock_close_xpm, "stock_close_xpm");
   pragma Import (C, stock_left_arrow_xpm, "stock_left_arrow_xpm");
   pragma Import (C, stock_open_xpm, "stock_open_xpm");
   pragma Import (C, stock_preferences_xpm, "stock_preferences_xpm");
   pragma Import (C, stock_right_arrow_xpm, "stock_right_arrow_xpm");
