...
package Debugger.Base_Gdb.Gdb_MI is
   ...
   overriding
   procedure Initialize (Debugger : access Gdb_MI_Debugger);

   overriding
   procedure Close (Debugger : access Gdb_MI_Debugger);
   ...
   overriding
   procedure Wait_Prompt (Debugger : access Gdb_MI_Debugger);
   ...
   overriding
   procedure Display_Prompt (Debugger : access Gdb_MI_Debugger);
   ...
   overriding
   procedure Detect_Language (Debugger : access Gdb_MI_Debugger);
   ...
   overriding
   function Info_Args (Debugger : access Gdb_MI_Debugger) return String;
   ...
   overriding
   procedure Catch_Exception (Debugger : access Gdb_MI_Debugger);
   ...
   overriding
   function Current_Frame (Debugger : access Gdb_MI_Debugger) return Integer;

   overriding
   procedure Interrupt (Debugger : access Gdb_MI_Debugger);
   ...
   procedure Put_Memory_Byte
     (Debugger : access Gdb_MI_Debugger; Address : String; Byte : String);
   ...
   overriding
   procedure Open_Processes (Debugger : access Gdb_MI_Debugger);
   ...
   overriding
   procedure Close_Processes (Debugger : access Gdb_MI_Debugger);

   overriding
   function Support_TTY (Debugger : access Gdb_MI_Debugger) return Boolean;

   overriding
   procedure Set_TTY (Debugger : access Gdb_MI_Debugger; TTY : String);
...
private
   ...
   package Nodes_Vectors is new
     Standard.Ada.Containers.Vectors (Positive, Node_Access);
