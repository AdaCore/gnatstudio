...
package body GVD.Preferences is
   ...
   is
      Debugger_Page : constant Preferences_Page :=
        Prefs.Get_Registered_Page
          (Name => "Debugger", Create_If_Needed => True);
   ...
   begin
      ...
      Debugger_Page.Register_Group
        (Name => "General", Group => General_Group, Priority => 1);
      ...
      Cancel_Multiple_Symbols :=
        Create
          (Manager => Prefs,
           ...
           Path    => -"Debugger:General",
           Default =>
             not GNATCOLL.Traces.Active (GPS.Kernel.Testsuite_Handle));
      ...
      Debugger_Console_All_Interactions :=
        Create_Invisible_Pref
          (Manager => Prefs,
