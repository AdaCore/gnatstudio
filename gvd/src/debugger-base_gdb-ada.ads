...
package Debugger.Base_Gdb.Ada is
   ...
   type Predefined_Type_Constructor is
     access function return GVD.Variables.Types.GVD_Type_Holder;

   package Predefined_Type_Maps is new
     Standard.Ada.Containers.Indefinite_Ordered_Maps
       (String,
        Predefined_Type_Constructor);

   Predefined_Type_Reestr : Predefined_Type_Maps.Map;

private

   type Gdb_Ada_Language is new Language.Debugger.Language_Debugger
   with null record;
