...
package body GVD.Canvas is
      ...
      begin
         if Item.all in Display_Item_Record'Class then
            Display_Item (Item).Set_Width_Range
              (Max => (Unit_Pixels, Gdouble
                       (Integer'(Max_Item_Width.Get_Pref))));
            Display_Item (Item).Set_Height_Range
              (Max => (Unit_Pixels, Gdouble
                       (Integer'(Max_Item_Height.Get_Pref))));
         end if;
      end Resize_Item;
   ...
   begin
      ...
      Item.Set_Width_Range
        (Max => (Unit_Pixels, Gdouble (Integer'(Max_Item_Width.Get_Pref))));
      Item.Set_Height_Range
        (Max => (Unit_Pixels, Gdouble (Integer'(Max_Item_Height.Get_Pref))));
