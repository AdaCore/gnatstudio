...
package GVD.Variables.Types.Simples is
   ...
   function Get_Value
     (Self : not null access GVD_Simple_Type) return Unbounded_String;
   --  Return the current value of Item (or null if it is not known).

   procedure Set_Value
     (Self : not null access GVD_Simple_Type; Value : String);
   ...
   function New_Range_Type (Min, Max : Long_Integer) return GVD_Type_Holder;
   ...
   function New_Mod_Type (Modulo : Long_Integer) return GVD_Type_Holder;
...
private
   ...
   function Replace
     (Parent             : not null access GVD_Base_Simple_Type;
      ...
      Dummy_Replace_With : GVD_Type_Holder'Class) return GVD_Type_Holder'Class
   ...
   overriding
   procedure Clear (Self : not null access GVD_Simple_Type);
   ...
   overriding
   procedure Reset_Recursive (Self : not null access GVD_Simple_Type);
   ...
   overriding
   function Get_Type_Descr (Self : not null access GVD_Mod_Type) return String
   ...
   overriding
   function Get_Type_Descr
     (Self : not null access GVD_Access_Type) return String
   is ("Access");
   ...
   overriding
   function Get_Type_Descr (Self : not null access GVD_Enum_Type) return String
   is ("Enumeration");
   ...
   overriding
   procedure Clear (Self : not null access GVD_Debugger_Output_Type);
   ...
   overriding
   procedure Free (Self : not null access GVD_Debugger_Output_Type);
   ...
   overriding
   function At_End (Self : Field_Iterator) return Boolean;
   overriding
   procedure Next (Self : in out Field_Iterator);
   overriding
   function Field_Name
     (Self : Field_Iterator;
   ...
   overriding
   function Data (Self : Field_Iterator) return GVD_Type_Holder'Class;
