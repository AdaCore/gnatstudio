...
package Debugger.LLDB is
   ...
   overriding
   procedure Initialize (Debugger : access LLDB_Debugger);
   ...
   overriding
   procedure Close (Debugger : access LLDB_Debugger);
   ...
   overriding
   procedure Detect_Language (Debugger : access LLDB_Debugger);
   ...
   overriding
   procedure Wait_Prompt (Debugger : access LLDB_Debugger);
   ...
   overriding
   procedure Display_Prompt (Debugger : access LLDB_Debugger);
   ...
   overriding
   function Info_Args (Debugger : access LLDB_Debugger) return String;
   ...
   overriding
   procedure Catch_Exception (Debugger : access LLDB_Debugger);

   overriding
   function Get_Executable
     (Debugger : access LLDB_Debugger) return GNATCOLL.VFS.Virtual_File;
   ...
   function Line_Contains_Code
     (Debugger   : not null access LLDB_Debugger;
      ...
      Dummy_Line : Editable_Line_Type) return Boolean
   is (True);

   overriding
   procedure Interrupt (Debugger : access LLDB_Debugger);
   ...
   overriding
   function Current_Frame (Debugger : access LLDB_Debugger) return Integer;
   ...
   procedure Set_Register
     (Debugger : access LLDB_Debugger; Name : String; Value : String);
   ...
   procedure Put_Memory_Byte
     (Debugger : access LLDB_Debugger; Address : String; Byte : String);
   ...
   overriding
   procedure Open_Processes (Debugger : access LLDB_Debugger);
   ...
   overriding
   procedure Close_Processes (Debugger : access LLDB_Debugger);

   overriding
   procedure Set_TTY (Debugger : access LLDB_Debugger; TTY : String);
