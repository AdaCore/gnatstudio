...
package Debugger.Base_Gdb.C is
   ...
   type Gdb_C_Language is new Language.Debugger.Language_Debugger with private;
...
private
   ...
   type Gdb_C_Language is new Language.Debugger.Language_Debugger
   with null record;

   overriding
   function Get_Name (Lang : access Gdb_C_Language) return String;
   --  See inherited documentation

   overriding
   function Is_Interpolation_Char
     (Lang : access Gdb_C_Language; Char : Wide_Wide_Character) return Boolean
   is (False);
