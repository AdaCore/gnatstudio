...
@c ACT manuals. See end of file for ACT specific modifications.
@c Add "@input texiplus" as second line to your *.texi file to use this.
@c The actual page size is 19x23 cm, cut to this size after printing
@c on letter or a4 paper.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The following permits starting a TOC on a specific positive pageno
% it is not suitable for general info use, so we don't bother with 
% a fancy @ command--just dip into tex mode and set \contentspageno.
\newcount\contentspageno \contentspageno=-1
\def\startcontents#1{%
   \pagealignmacro
   \immediate\closeout \tocfile
   \ifnum \pageno>0
      \pageno = \contentspageno		% Request roman numbered pages.
   \fi
