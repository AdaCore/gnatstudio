...
package VSS.Implementation.Python3 is
   ...
   with Import, Convention => C, External_Name => "PyBytes_AsString";
   ...
   function PyBytes_AsStringAndSize
     (Obj    : GNATCOLL.Python.PyObject;
      Buffer :
        out VSS.Implementation.Interfaces_C.UTF8_Code_Unit_Constant_Access;
      Size   : out Py_ssize_t) return Integer
   with Import, Convention => C, External_Name => "PyBytes_AsStringAndSize";
