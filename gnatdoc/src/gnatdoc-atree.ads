...
private package GNATdoc.Atree is
   ...
   function Is_Generic
     (E : Entity_Id) return Boolean;
   --  Use always this subprogram to know if E corresponds with a generic
   --  package or subprogram since LL.Is_Generic is not available in
   --  internal entities generated by the frontend to workaround missing
   --  entities associated with generics.
